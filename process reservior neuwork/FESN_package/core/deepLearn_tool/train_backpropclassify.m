...
w_class = 0.1*randn(size(w3,2)+1,num_class);
...
%%%%%%%%%%%%%% END OF COMPUTING TEST MISCLASSIFICATION ERROR %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 tt=0;
 for batch = 1:numbatches/num_class
...
%%%%%%%%%%% COMBINE 10 MINIBATCHES INTO 1 LARGER MINIBATCH %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 targets=[]; 
 for kk=1:num_class
  data=[data; batchdata(:,:,(tt-1)*num_class+kk)]; 
  targets=[targets; batchtargets(:,:,(tt-1)*num_class+kk)];
 end 
...
%%%%%%%%%%%%%%% END OF CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 save weights w1 w2 w3 w_class
%  save error test_err test_crerr train_err train_crerr;
